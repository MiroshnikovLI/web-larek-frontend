...
[1]Класс Api используется для взаимодействия с REST API.

[2]Класс BasketData описывает структуру и поведение данных корзины.

[3]Класс ProductCardManager используется для работы с карточками продуктов и управления заказами.

[4]Класс Order используется для управления информацией о заказе.

[5]Класс BaseCard описывает структуру и поведение элементов карточки.

[6]Класс CatologProduct используется для создания элементов каталога продуктов.

[7]Класс Card используется для создания карточек продуктов.

[8]Класс CardBasket используется для создания карточек продуктов в корзине.

[9]Класс BasketElement описывает структуру и поведение элемента корзины.

[10]Класс Basket описывает структуру и поведение корзины.

[11]Класс Form используется для работы с формами.

[12]Класс FormOrder используется для работы с формой заказа.

[13]Класс FormContact используется для работы с формой контактов.

[14]Класс Success используется для отображения окна с оповещением о завершении покупки.

[15]Класс ValidForm, используеться для валидации информации.
...
### [6]Вывод карточки на главый экран
...
[10]Класс Basket, расширяет класс BasketElement и реализует интерфейс IBasket. Класс описывает структуру и поведение корзины.
...
### [14]Оповещение об успешном совершение покупки
